...
kable(trt_all, digits=2, format="markdown")
```
...
kable(trt_all_tidy, digits=2, format="markdown")
```
...
Comparing the variances between groups, the Decompensated group has a true variance which is 59.3% larger than the Compensated group, and an error variance which is 44.3% larger.
...
knitr::kable(tidytrt, digits = 2, format="markdown")
```
...
![](figures/unnamed-chunk-66-2.png)<!-- -->
...
![](figures/unnamed-chunk-76-2.png)<!-- -->
...
![](figures/unnamed-chunk-77-1.png)<!-- -->
...
![](figures/unnamed-chunk-77-2.png)<!-- -->
