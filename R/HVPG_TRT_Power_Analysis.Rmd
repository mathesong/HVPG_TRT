...
Comparing the variances between groups, the Decompensated group has a true variance which is `r round((((trt_all$sd[1])^2 / (trt_all$sd[2])^2) - 1)*100, 1)`% larger than the Compensated group, and an error variance which is `r round((((trt_all$wscv[1]*trt_all$mean[1])^2 / (trt_all$wscv[2]*trt_all$mean[2])^2) - 1)*100, 1)`% larger.
